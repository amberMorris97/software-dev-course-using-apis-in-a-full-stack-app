...
import org.launchcode.weather_dashboard.model.Weather;
...
public class WeatherService {
    ...
    public WeatherData getCurrentWeather(String city) {
        try {
            ...
            GeocodeResult[] geoResults = restTemplate.getForObject(GEO_URL, GeocodeResult[].class, city, API_KEY);
            ...
            WeatherData weather = restTemplate.getForObject(WEATHER_URL, WeatherData.class, lat, lon, API_KEY);
